...
@export_custom(PROPERTY_HINT_NONE,"suffix: x") var sky_turbo: float = 2
@export var sky_rot_speed : float = .1
@export_custom(PROPERTY_HINT_NONE,"suffix: mm") var sky_zoom_in : float = 30
@export_custom(PROPERTY_HINT_NONE,"suffix: mm") var sky_zoom_out : float = 100
